...
def addition_fail():
    print(".1 + .2:", .1 + .2)
    print(".1 + .2 == .3", .1 + .2 == .3)
    print(f".1:\t\t{pretty_float_bits(.1)}")  # .1 is repeated decimals
    print(f".2:\t\t{pretty_float_bits(.2)}")  # .2 is also repeated decimals
...
def nans():
    ...
    # nan is only object that do not get compared to themselves
